...
export function FulfillmentPage() {
  ...
  const confirmPlan = async () => {
    try {
      // Find warehouse ids from DB or match allocations
    ...
    <div className="flex items-center justify-between pb-space-xs">
      <div className="flex items-center gap-3">
        <div>
          ...
          <p className="font-body-sm text-body-sm text-outline mt-0.5">{fulfillmentOrder.customer} <span className="mx-1">·</span> From Quote #Q-1042</p>
        </div>
