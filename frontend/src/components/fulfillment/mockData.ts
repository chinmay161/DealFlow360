...
export const fulfillmentOrder: FulfillmentOrder = {
  reference: "ORD-1042", sourceQuote: "Q-1042", customer: "Acme Corporation", orderValue: 18300,
  physicalUnits: 15, status: "Ready for Fulfillment", approval: "Approved", salesRepresentative: "James Carter",
};
...
export const warehouseStock: WarehouseStock[] = [
  ...
  { productId: "laptop", warehouse: "Pune Warehouse", available: 7, reserved: 0, fulfillable: 7 },
  ...
  { productId: "display", warehouse: "Pune Warehouse", available: 4, reserved: 1, fulfillable: 3 },
...
export const recommendedAllocations: WarehouseAllocation[] = [
  { warehouse: "Mumbai Warehouse", allocations: { laptop: 5, display: 3 }, availableStock: 8, estimatedShippingCost: 700, shipmentGroups: 2 },
  { warehouse: "Pune Warehouse", allocations: { laptop: 5, display: 2 }, availableStock: 10, estimatedShippingCost: 500, shipmentGroups: 2 },
];
...
export const shipments: Shipment[] = [
  { id: "SHP-1001", warehouse: "Mumbai Warehouse", items: [{ productId: "laptop", quantity: 5 }, { productId: "display", quantity: 3 }], status: "Ready to Ship", estimatedShippingCost: 700 },
  { id: "SHP-1002", warehouse: "Pune Warehouse", items: [{ productId: "laptop", quantity: 5 }, { productId: "display", quantity: 2 }], status: "Ready to Ship", estimatedShippingCost: 500 },
];
