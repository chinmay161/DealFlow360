  ...
  return (
    <>
      ...
      <div className="flex items-center gap-1.5 text-label-sm font-label-sm text-outline">
        <a className="hover:text-primary transition-colors" href="#">Quotations</a>
        <span className="material-symbols-outlined text-xs" data-icon="chevron_right">chevron_right</span>
        <span className="text-on-surface-variant">Q-1042</span>
        <span className="material-symbols-outlined text-xs" data-icon="chevron_right">chevron_right</span>
      ...
      <div className="flex items-center justify-between pb-space-xs">
        <div className="flex items-center gap-3">
          <h1 className="font-headline-sm text-headline-sm font-bold text-on-surface tracking-tight">Create Quotation #Q-1042</h1>
          {/* Customer Tier Badge */}
          <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-label-sm font-semibold bg-[#FFFBEB] text-[#92400E] border border-[#FDE68A]">
            <span className="material-symbols-outlined text-xs text-[#D97706]" data-icon="workspace_premium">workspace_premium</span>
            <span>Gold Tier</span>
          </div>
          ...
          <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-label-sm font-medium bg-[#EFF6FF] text-[#1E40AF] border border-[#BFDBFE]">
            <span className="material-symbols-outlined text-xs" data-icon="sell">sell</span>
            <span>Enterprise Price List 2025</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button className="h-8 px-3 rounded-md border border-[#D1D5DB] bg-white text-on-surface font-label-md text-label-md hover:bg-[#F9FAFB] flex items-center gap-1.5 transition-colors shadow-sm">
            <span className="material-symbols-outlined text-sm" data-icon="history">history</span>
            <span>Revision History (v3)</span>
          </button>
        </div>
      </div>
    </>
