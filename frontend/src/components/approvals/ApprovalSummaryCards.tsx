...
export const ApprovalSummaryCards: React.FC = () => {
  return (
    <div className="grid grid-cols-4 gap-space-base">
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-lg p-space-base shadow-[0px_1px_2px_rgba(15,23,42,0.04)] flex flex-col justify-between">
        ...
        <div className="pt-2 border-t border-[#F1F5F9] flex items-center justify-between font-body-sm text-[11px] text-outline">
          ...
          <span className="font-medium text-[#065F46]">Processed successfully</span>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-lg p-space-base shadow-[0px_1px_2px_rgba(15,23,42,0.04)] flex flex-col justify-between">
        <div className="flex items-center justify-between">
          ...
          <span className="material-symbols-outlined text-primary text-base" data-icon="timelapse">
            timelapse
          </span>
        </div>
        <div className="my-2 flex items-baseline justify-between">
        ...
        <div className="pt-2 border-t border-[#F1F5F9] flex items-center justify-between font-body-sm text-[11px] text-outline">
          ...
          <span className="font-medium text-on-surface">18% faster than last week</span>
        </div>
      </div>
    </div>
  );
